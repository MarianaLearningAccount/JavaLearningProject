package com.mariana.gitworkflow;
...
public class GitWorkflow {
    public static void main(String[] args) {
        ...
        String step3a = "Perform git pull command - to fetch and download content from the origin/master and immediately" +
                " update the local master to match that content;"
