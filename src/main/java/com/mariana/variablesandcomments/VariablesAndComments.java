package com.mariana.variablesandcomments;

public class VariablesAndComments {
    public static void main(String[] args) {

//  Am declarat toate tipurile de variabile primitive
...
//  Initializarea variabilelor declarate
        ...
        lowerLimitOfFloatDataType = -3.4E+36f;
        upperLimitOfFloatDataType = 3.4E+36f;
